#include <Arduino.h>
#line 1 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
...
#line 202 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void initMPU();
#line 229 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void calibrateGyro();
#line 270 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void readMPU(float *gx_dps, float *gy_dps, float *gz_dps);
#line 292 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
int16_t integrateAndFuseGyro(float gyro_dps, int16_t hall_rotation, int axis, float dt_sec);
#line 319 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void send_command_alt(int16_t rx, int16_t ry, int16_t rz, int16_t x, int16_t y, int16_t z);
#line 434 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void readAllFromSensors(int *rawReads);
#line 456 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void readAllFromButtons(uint8_t *buttonValues);
#line 608 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void send_command(int16_t rx, int16_t ry, int16_t rz, int16_t x, int16_t y, int16_t z, uint8_t *buttonValues);
#line 654 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void setup();
#line 693 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void loop();
#line 202 "Y:\\Hall-Effect-Sensor-CAD-Mouse-Spacemouse\\HE_Spacemouse\\HE_Spacemouse.ino"
void initMPU()
{
